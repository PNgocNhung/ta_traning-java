package com.epam.trainning.ngocnhung.clean_code.aircompany.src.test;

import com.epam.trainning.ngocnhung.clean_code.aircompany.src.main.Airport;
...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        for (MilitaryPlane militaryPlane : transportMilitaryPlanes) {
            assertEquals(MilitaryType.TRANSPORT, militaryPlane.getType());
        }
    }
    ...
    public void testGetPassengerPlaneWithMaxCapacity() {
        ...
        assertEquals(expectedPlaneWithMaxPassengerCapacity, actualPlaneWithMaxPassengersCapacity);
    }
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        assertEquals(false, bomberMilitaryPlanes.contains(MilitaryType.BOMBER));
    }
