package com.epam.trainning.ngocnhung.classes.domain_model.src.main.candies;
...
public class Candy extends CandyBase {
    ...
    public int getWeight() {
         ...
         */
        if (weight <= 0) throw new UnsupportedOperationException("Weight should be positive");
        return weight;
    }
    /**
